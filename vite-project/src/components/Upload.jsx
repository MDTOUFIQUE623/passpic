...
const Upload = () => {
  return (
    <div className='pb-16'>
        {/* Title */}
      <h1 className='text-center text-2xl md:text-3xl lg:text-4xl font-semibold text-neutral-200 py-6 md:p16'>See the magic. 
        <span className='bg-gradient-to-r from-purple-500 to-orange-400 bg-clip-text text-transparent'> Try now </span></h1>
