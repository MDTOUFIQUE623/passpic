    ...
    <div className='flex items-center justify-between mx-4 py-1 lg:mx-44 mt-[-8px]'>
        ...
        </Link>
        {
            isSignedIn?<div className='flex items-center gap-2 sm:gap-3'> 
                <button onClick={()=>navigate('/buy')} className='relative group overflow-hidden bg-gradient-to-r from-zinc-900 to-zinc-800 px-4 sm:px-7 py-1.5 sm:py-2.5 rounded-full hover:scale-105 transition-all duration-500'>
                    <div className='absolute inset-0 bg-gradient-to-r from-blue-500/10 to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300'></div>
                    
                    <div className='flex items-center gap-2 relative z-10'>
                        <img className='w-5 group-hover:rotate-180 transition-transform duration-700' src={assets.credit_icon} alt="" />
                        <p className='text-sm sm:text-sm font-medium bg-gradient-to-r from-blue-200 to-blue-100 bg-clip-text text-transparent'>
                            Credits: {credit}
                        </p>
                    </div>
                    
                    <div className='absolute top-0 right-0 w-2 h-2 border-t-2 border-r-2 border-blue-500/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300'></div>
                    <div className='absolute bottom-0 left-0 w-2 h-2 border-b-2 border-l-2 border-purple-500/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300'></div>
                </button>
